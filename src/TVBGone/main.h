...
#define IRLED IR_TX_PIN        //the IR sender LED / D5 on wemos D1 mini
#define TRIGGER BUTTON1      //the button pin / D6 on wemos D1 mini
#define REGIONSWITCH BUTTON2  //HIGH (1) = NA, LOW (0) = EU; Pin 5 / D1 (REGIONSWITCH) is HIGH (via in input pullup resistor) for North America, or you (the user) must wire it to ground to set the codes for Europe.
